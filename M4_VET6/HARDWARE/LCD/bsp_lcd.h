...
void DrawRGBImage(uint16_t Xpos, uint16_t Ypos, uint16_t Xsize, uint16_t Ysize, u8 *pData);	// 显示一张RGB图片
...
void LCD_Set_Window(u16 Xstart,u16 Xend,u16 Ystart,u16 Yend);	// 设置窗口					   						   																			 
